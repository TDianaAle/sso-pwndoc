...
// Session config for Passport for SSO
// Required for Keycloak SSO: the IdP redirects back from a different domain
// and SameSite: 'lax' ensures the session cookie is sent on the GET callback
// Session store in MongoDB - required for OIDC state persistence across redirects
app.use(session({
...
// Logs unhandled errors; these should be properly handled as part of the new SSO implementation.
